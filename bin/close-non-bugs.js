...
require('machine-as-script')({
  ...
  // Use the default environment variable namespace, 3 underscores ("___")
  // envVarNamespace: '___',
  ...
  machine: {
    ...
    inputs: {
      ...
      nonIssueLabel: {
        friendlyName: 'Label to close',
        description: 'The name of an issue label.',
        extendedDescription: 'If any issues have this label, they will be closed. Note that the label name comparison is case-insensitive.',
        example: 'question',
        required: true
      }
    ...
    fn: function (inputs, exits) {
      ...
      console.log('Cleaning up issues that have any of the following labels: ',inputs.nonIssueLabel);
      ...
      async.each(inputs.repos, function (repo, next){
        ...
        Github.searchIssues({
          ...
          repo: repo.repoName,
          state: 'open',
          withAllOfTheseLabels: [ inputs.nonIssueLabel ],
